...
$_LANG['cp_home'] = 'Management Center';
$_LANG['copyright'] = 'Management system, actually very simple';
...
$_LANG['11_order_back'] = 'Relevant application list'; /* add by mofangweb.com 退换货插件 加强版 */
