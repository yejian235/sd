...
$_LANG['agreement'] = "我已看过并接受《<a href=\"article.php?cat_id=-1\" style=\"color:#70a4c1\" target=\"_blank\">用户协议</a>》";
...
$_LANG['your_level'] = '%s ';
$_LANG['next_level'] = '您还差 <span>%s</span> 积分达到 <span>%s</span> ';
$_LANG['attention'] = '关注';
...
$_LANG['passport_js']['username_empty'] = '<span>用户名不能为空。</span>';
$_LANG['passport_js']['username_shorter'] = '<span>用户名长度不能少于 3 个字符。</span>';
$_LANG['passport_js']['username_invalid'] = '<span>用户名只能是由字母数字以及下划线组成。</span>';
$_LANG['passport_js']['password_empty'] = '<span>登录密码不能为空。</span>';
$_LANG['passport_js']['password_shorter'] = '<span>登录密码不能少于 6 个字符。</span>';
$_LANG['passport_js']['confirm_password_invalid'] = '<span>两次输入密码不一致</span>';
$_LANG['passport_js']['email_empty'] = '<span>Email 为空</span>';
$_LANG['passport_js']['email_invalid'] = '<span>Email 不是合法的地址</span>';
$_LANG['passport_js']['agreement'] = "<span>您没有接受协议</span>";
$_LANG['passport_js']['msn_invalid'] = '<span>msn地址不是一个有效的邮件地址</span>';
$_LANG['passport_js']['qq_invalid'] = '<span>QQ号码不是一个有效的号码</span>';
$_LANG['passport_js']['home_phone_invalid'] = '<span>家庭电话不是一个有效号码</span>';
$_LANG['passport_js']['office_phone_invalid'] = '<span>办公电话不是一个有效号码</span>';
$_LANG['passport_js']['mobile_phone_invalid'] = '<span>手机号码不是一个有效号码</span>';
$_LANG['passport_js']['mobile_phone_empty'] = '<span>手机号码不能为空</span>';
$_LANG['passport_js']['msg_un_blank'] = '<span>用户名不能为空</span>';
$_LANG['passport_js']['msg_un_length'] = '<span>用户名最长不得超过7个汉字</span>';
$_LANG['passport_js']['msg_un_format'] = '<span>用户名含有非法字符</span>';
$_LANG['passport_js']['msg_un_registered'] = '<span>用户名已经存在,请重新输入</span>';
$_LANG['passport_js']['msg_can_rg'] = '<p>可以注册</p>';
$_LANG['passport_js']['msg_email_blank'] = '<span>邮件地址不能为空</span>';
$_LANG['passport_js']['msg_email_registered'] = '<span>邮箱已存在,请重新输入</span>';
$_LANG['passport_js']['msg_email_format'] = '<span>邮件地址不合法</span>';
$_LANG['passport_js']['msg_blank'] = '<span>不能为空</span>';
$_LANG['passport_js']['no_select_question'] = '<span>您没有完成密码提示问题的操作</span>';
$_LANG['passport_js']['passwd_balnk'] = '<span>密码中不能包含空格</span>';
