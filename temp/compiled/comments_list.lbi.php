...
?>
  <div class="plZCO">
    <div class="plContent clearfix">
      <div class="plCinfo"><a href="javascript:void(0);" class="track"><?php if ($this->_var['comment']['username']): ?><?php echo htmlspecialchars($this->_var['comment']['username']); ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></a></div>
      <div class="plConr"> <span class="blank15"></span>
        <div class="plrfen">
        	<span class="plrfen_sp">评分：</span>
            <sub class="SpriteStar stars<?php echo $this->_var['comment']['rank']; ?>"></sub>
            <span class="blank5"></span>
            <span class="blank5"></span>
          <p class="danpv2_linex"> </p>
        </div>
        <div class="plCoNR clearfix"> <span>评价：</span>
          <label> <?php echo $this->_var['comment']['content']; ?></label>
     
        </div> 
      <?php if ($this->_var['comment']['re_content']): ?>
      <div class="plCoNR clearfix">
          <span style="width:5.5%;"><?php echo $this->_var['lang']['admin_username']; ?></span>
          <label style="width:94.5%;"><?php echo $this->_var['comment']['re_content']; ?></label>
      </div> 
      <?php endif; ?> 
       
        
        <span class="blank15"></span>
        <div style="_padding-bottom:62px;" class="plDYinfo"> <span class="TimePl">评论时间：<?php echo $this->_var['comment']['add_time']; ?></span> </div>
        <span class="blank0"></span>
        <div class="notesNewpl notesNewp0307" style="display: none;"> </div>
        <span class="blank0"></span> </div>
    </div>
    <div class="clear"> </div>
    <p class="Sdanpyyimg"> </p>
  </div>
...
<div id="pagebar" class="f_r">
  <form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
    ...
    <div id="pager"> <?php echo $this->_var['lang']['pager_1']; ?><?php echo $this->_var['pager']['record_count']; ?><?php echo $this->_var['lang']['pager_2']; ?><?php echo $this->_var['lang']['pager_3']; ?><?php echo $this->_var['pager']['page_count']; ?><?php echo $this->_var['lang']['pager_4']; ?> <span> <a href="<?php echo $this->_var['pager']['page_first']; ?>"><?php echo $this->_var['lang']['page_first']; ?></a> <a href="<?php echo $this->_var['pager']['page_prev']; ?>"><?php echo $this->_var['lang']['page_prev']; ?></a> <a href="<?php echo $this->_var['pager']['page_next']; ?>"><?php echo $this->_var['lang']['page_next']; ?></a> <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> </span> 
      <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_70250500_1488594665');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_70250500_1488594665']):
?>
      <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_70250500_1488594665']; ?>" />
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
    </div>
    <?php else: ?> 
    ...
    <div id="pager" class="pagebar"> <span class="f_l f6" style="margin-right:10px;"><?php echo $this->_var['lang']['total']; ?> <b><?php echo $this->_var['pager']['record_count']; ?></b> <?php echo $this->_var['lang']['user_comment_num']; ?></span> 
      ...
      <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_70279200_1488594665');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_70279200_1488594665']):
?> 
      <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?> 
      <span class="page_now"><?php echo $this->_var['key']; ?></span> 
      <?php else: ?> 
      <a href="<?php echo $this->_var['item_0_70279200_1488594665']; ?>">[<?php echo $this->_var['key']; ?>]</a> 
      <?php endif; ?> 
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
      ...
      <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_70312300_1488594665');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_70312300_1488594665']):
?>
      <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_70312300_1488594665']; ?>" />
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
...
<div id="comment_show" style="width: 666px; height: 283px; display:none;" class=" jqmID1">
  <div class="popbox" style="background:none; width:664px;">
    <div class="popc" style="width:664px;">
      <h2 id="easyDialogTitle"><a class="popwinClose" href="javascript:;">关闭</a>发表评论</h2>
      <div class="commentsList2 stat_box" >
        <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
          <table width="630" border="0" cellspacing="5" cellpadding="0" >
            ...
            <tr>
              ...
              <td><input type="text" name="email" id="email"  maxlength="100" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" class="inputBorder" style="height:28px;"/></td>
            </tr>
            <tr>
          ...
          <span class="star s4"></span>
            ...
            <tr>
              <td colspan="2"><?php if ($this->_var['enabled_captcha']): ?>
                ...
                <div style="padding-left:15px; text-align:left; float:left; line-height: 35px;vertical-align: top;"> <?php echo $this->_var['lang']['comment_captcha']; ?>：
                  <input type="text" name="captcha"  class="inputBorder" style="height:28px; width:50px; padding:0; margin-top:3px; vertical-align:top"/>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_70362400_1488594665');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_70362400_1488594665']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_70362400_1488594665']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
