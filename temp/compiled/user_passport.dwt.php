...
?>
                        ...
                        <?php else: ?>
                        <li class="clearfix form-item"><label <?php if ($this->_var['field']['is_need']): ?> id="extend_field<?php echo $this->_var['field']['id']; ?>i" <?php endif; ?>><?php echo $this->_var['field']['reg_field_name']; ?>：</label><input class="x-input" type="text" name="extend_field<?php echo $this->_var['field']['id']; ?>"><span class="x-text"><?php echo $this->_var['field']['reg_field_name']; ?></span><?php if ($this->_var['field']['is_need']): ?><div id="email_notice" class="Judge"></div><?php endif; ?><div class="Tips"><span>请输入您常用的<?php echo $this->_var['field']['reg_field_name']; ?><i></i></span></div></li>
                        <?php endif; ?>
