...
?> 
    ...
    <?php endif; ?>
    <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_88777700_1488442542');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_88777700_1488442542']):
?>
    <div class="f-l where">
    	<div class="first"><?php echo htmlspecialchars($this->_var['filter_attr_0_88777700_1488442542']['filter_attr_name']); ?>：</div>
        <ul class="where-ul">
            <?php $_from = $this->_var['filter_attr_0_88777700_1488442542']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
