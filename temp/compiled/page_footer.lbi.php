  ...
  <div class="box_1" style="border:none;">
    <div class="bNavList clearfix">
      <div class="f_l"> 
        ...
        <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_67886700_1489473852');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_67886700_1489473852']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?> 
        <a href="<?php echo $this->_var['nav_0_67886700_1489473852']['url']; ?>" <?php if ($this->_var['nav_0_67886700_1489473852']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_67886700_1489473852']['name']; ?></a> 
...
?> 
    <?php if ($this->_var['im']): ?> 
    <a href="http://edit.yahoo.com/config/send_webmesg?.target=<?php echo $this->_var['im']; ?>n&.src=pg" target="_blank"><img src="themes/21cake/images/yahoo.gif" width="18" height="17" border="0" alt="Yahoo Messenger" /> <?php echo $this->_var['im']; ?></a> 
    <?php endif; ?> 
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
...
?> 
    <?php if ($this->_var['im']): ?> 
    <img src="themes/21cake/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=<?php echo $this->_var['im']; ?>"><?php echo $this->_var['im']; ?></a> 
    <?php endif; ?> 
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
...
<div class="copyRight">
    ...
    <div class="copyRightR">
        <?php if ($this->_var['navigator_list']['bottom']): ?> 
            <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_68073200_1489473852');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_68073200_1489473852']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
            <?php if ($this->_foreach['nav_bottom_list']['iteration'] < 4): ?>
            &nbsp;&nbsp;<a href="<?php echo $this->_var['nav_0_68073200_1489473852']['url']; ?>" <?php if ($this->_var['nav_0_68073200_1489473852']['opennew'] == 1): ?>target="_blank"<?php endif; ?> ><?php echo $this->_var['nav_0_68073200_1489473852']['name']; ?></a>
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
        <?php endif; ?>
    </div>
