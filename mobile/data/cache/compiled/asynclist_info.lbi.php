...
<?php if ($this->_var['goods']): ?>
      <div class="pro-inner">
        <div class="proImg-wrap"> <a href="<?php echo $this->_var['goods']['url']; ?>"> <img src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo $this->_var['goods']['name']; ?>"> </a> </div>
        <div class="proInfo-wrap">
          <div class="proTitle"> <a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo $this->_var['goods']['name']; ?></a> </div>
          <div class="proSKU"></div>
          <div class="proPrice">
            <em><?php if ($this->_var['goods']['promote_price']): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?></em> 
          </div>
...
<dl>
  ...
  <dd><span class="pull-left"><strong><?php echo $this->_var['lang']['price']; ?>：<b class="ect-colory"><?php if ($this->_var['act_goods']['promote_price']): ?><?php echo $this->_var['act_goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['act_goods']['shop_price']; ?><?php endif; ?></b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['act_goods']['market_price']; ?></del></small></span>
...
<dl>
  ...
  <dd class="dd-price"><span class="pull-left"><strong><?php echo $this->_var['lang']['price']; ?>：<b class="ect-colory"><?php echo $this->_var['groupbuy']['cur_price']; ?></b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['groupbuy']['market_price']; ?></del></small></span><span class="ect-pro-price"> 
   <i class="label zk"><?php echo $this->_var['groupbuy']['spare_discount']; ?><?php echo $this->_var['lang']['favourable_zk']; ?></i> 
    </span></dd>
...
<dl>
  ...
  <dd><span class="pull-left"><strong><b class="ect-colory"><?php echo $this->_var['exchange']['exchange_integral']; ?>积分</b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['exchange']['market_price']; ?></del></small></span>
</dd>
...
<tbody><tr>
        	<td class="order_status" style="border-bottom:1px #CCCCCC dashed"><?php echo $this->_var['lang']['order_status']; ?>：<?php echo $this->_var['orders']['order_status']; ?></td>
        </tr>
        <tr>
        	<td class="order_content"><a href="<?php echo url('user/order_detail');?>&order_id=<?php echo $this->_var['orders']['order_id']; ?>"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table_no_border">
            <tbody><tr>
                <td><img src="<?php echo $this->_var['orders']['img']; ?>" width="50" height="50"></td>
                <td><?php echo $this->_var['lang']['order_number']; ?>：<?php echo $this->_var['orders']['order_sn']; ?><br>
                <?php echo $this->_var['lang']['order_total_fee']; ?>：<?php echo $this->_var['orders']['total_fee']; ?><br>
...
<div class="shInfo "> 
          <dl><a href="<?php echo $this->_var['consignee']['url']; ?>">
            <dt><?php echo $this->_var['consignee']['consignee']; ?> <span style="color:#F90"><?php echo $this->_var['consignee']['mobile']; ?></span></dt>
            <dd>
              <?php echo $this->_var['consignee']['address']; ?> 
            </dd></a>
          </dl>
          </div>
<?php endif; ?> 
...
<dt>
  ...
  <dd><div class="flow-del text-center"><a onclick="addToCart_quick(<?php echo $this->_var['fittings']['goods_id']; ?>)" href="javascript:;"><?php echo $this->_var['lang']['btn_add_to_cart']; ?></a></div></dd>
</dl>
...
<?php if ($this->_var['msg']): ?>
	<p>
    <a style="color:#1CA2E1; float:right; font-weight:normal;" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_remove_msg']; ?>？')) return false;" href="<?php echo $this->_var['msg']['url']; ?>"><?php echo $this->_var['lang']['drop']; ?></a><?php echo $this->_var['msg']['msg_type']; ?>：<?php echo $this->_var['msg']['msg_title']; ?> - <?php echo $this->_var['msg']['msg_time']; ?>
    </p>
