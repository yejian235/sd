          ...
          <table id="general-table" class="table table-hover ectouch-table">
            <tr>
              ...
              <td><div class="col-md-4">
                  <input type='text' name='topic_name' maxlength="20"  datatype="*"  nullmsg="{$lang['topic_title']}" value="{$topic['title']}" class="form-control input-sm" />
                </div></td>
            </tr>
            <tr>
              <td width="200">{$lang['lable_topic_keywords']}</td>
              <td><div class="col-md-6">
                  <textarea class="form-control input-sm" rows="6" name='data[keywords]'>{$topic['keywords']}</textarea>
                </div></td>
            </tr>
            <tr>
              <td width="200">{$lang['lable_topic_description']}</td>
              <td><div class="col-md-4">
                  <input type='text' name='data[description]' value="{$topic['description']}" maxlength="20"  class="form-control input-sm" />
                </div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><div class="col-md-4">
                  <input type='text' name='start_time' id="start_time" maxlength="100"  class="form-control input-sm" value="{$topic[start_time]}" />
                </div></td>
            </tr>
            <tr>
              <td width="200">{$lang['end_time']}</td>
              <td><div class="col-md-4">
                  <input type='text' name='end_time' id="end_time" maxlength="100"  class="form-control input-sm" value="{$topic[end_time]}" />
                </div></td>
            </tr>
          </table>
        </div>
