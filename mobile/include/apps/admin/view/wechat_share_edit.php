...
<div class="panel-body">
	<form action="{url('share_edit')}" method="post" class="form-horizontal" role="form" onSubmit="return false;">
      <table id="general-table" class="table table-hover ectouch-table">
        <tr>
          <td width="200">{$lang['share_name']}:</td>
          <td><div class="col-md-6">
              <input type="text" name="data[username]" class="form-control input-sm" />
            </div></td>
        </tr>
        <tr>
          <td width="200">{$lang['share_userid']}:</td>
          <td><div class="col-md-6">
        ...
        <tr>
          ...
          <td><div class="col-md-6">
              ...
              <span class="help-block">{$lang['share_help']}</span>
            </div></td>
        </tr>
        <tr>
