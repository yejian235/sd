...
$_LANG['get_new_pwd'] = '找回密码';
$_LANG['goto_login'] = '返回继续登录';

$_LANG['login_faild'] = '用户名或密码不正确';
$_LANG['forget_faild'] = '用户名或邮箱不正确';
$_LANG['email_format_faild'] = '电子邮箱格式不正确';
$_LANG['captcha_error'] = '您输入的验证码不正确';
$_LANG['send_email_error'] = '电子邮件发送错误，请联系管理员';
