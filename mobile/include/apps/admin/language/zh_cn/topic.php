...
/* 提示信息 */
$_LANG['succed'] = '操作成功!';
$_LANG['notice_template_file'] = '选择当前专题的模板文件名,模板文件应上传到当前商城模板目录下,自定义模版名称以topc_开头。';
...
$_LANG['topic_name_empty'] = '请输入专题名称!';
$_LANG['start_time_empty'] = '请选择专题开始时间!';
$_LANG['end_time_empty'] = '请选择专题结束时间!';
