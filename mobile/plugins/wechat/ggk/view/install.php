...
<form action="{url('edit', array('ks'=>$config['command']))}" method="post" class="form-horizontal" role="form" onsubmit="if($('.prize_list tr').length > 10){alert('奖项不能超过9项');return false;}">
   ...
   <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <p class="help-block">注意：最多添加9项</p>
            </div>
        </td>
    </tr>
    <tr>
