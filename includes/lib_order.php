...
{
	/* modify by mofangweb.com 退换货插件 加强版 begin */
    $sql = "SELECT og.rec_id, og.goods_id, og.goods_name, og.goods_sn, og.market_price, og.goods_number, " .
		...
		"goods_price AS subtotal, og.extension_code " .
...
{
    $sql = "SELECT g.goods_thumb,c.*,".
            "c.goods_price * c.goods_number AS subtotal " .
            "FROM " . $GLOBALS['ecs']->table('cart') .
            " AS c LEFT JOIN ".$GLOBALS['ecs']->table('goods') ." AS g ON c.goods_id = g.goods_id WHERE session_id = '" . SESS_ID . "' " .
            "AND rec_type = '$type'";
